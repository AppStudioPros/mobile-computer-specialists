    ...
    <section className="relative py-24 lg:py-32 overflow-hidden bg-[var(--color-mcs-page)]">
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-[var(--color-mcs-text)] leading-tight mb-8">
            Once you&apos;re a customer,{" "}
            <span className="mcs-gradient-text">support never stops.</span>
          </h2>
          <div className="space-y-6 text-lg text-[var(--color-mcs-muted)] leading-relaxed">
            <p>
